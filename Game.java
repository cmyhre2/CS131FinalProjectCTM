 ...
 * 
 * @author Chris Myhre
 * @version 1.0 (CS-131 Final Project)
 * Spring 2023 (04/23/2023)
 */
public class Game{
	/*
	 * Game difficulty settings to set gem spawn chance to make the game harder/easier.
	 */
	enum Difficulty{;
		static int EASY = 2;//Sets gems to 50% spawn rate.
		static int NORMAL = 3;//Sets gems to 34% spawn rate.
		static int HARD = 5;//Sets gems to 20% spawn rate.
	}//end enum Difficuty
